...
var wsuCycleSlideshow = document.querySelector('.cycle-slideshow');


var addSliderKeypress = function( element ) {
...
addSliderKeypress( document.querySelector('.cycle-prev') );
addSliderKeypress( document.querySelector('.cycle-next') );
addSliderKeypress( document.querySelector('.wsu-cycle-pause') );