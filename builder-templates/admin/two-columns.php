		...
		<?php $j = 1; foreach ( $section_order as $key => $i ) : ?>
			...
			<div class="wsuwp-spine-halves-column wsuwp-spine-halves-column-position-<?php echo $j; ?>" data-id="<?php echo $i; ?>">
				...
				$editor_settings = array(
					'tinymce'       => array(
						'toolbar1' => 'bold,italic,link,underline,strikethrough,blockquote,alignleft,aligncenter,alignright,alignjustify,wp_adv',
						'toolbar2' => 'bullist,numlist,outdent,indent,removeformat,formatselect',
						'toolbar3' => '',
						'toolbar4' => '',
					),
					'quicktags'     => array(
