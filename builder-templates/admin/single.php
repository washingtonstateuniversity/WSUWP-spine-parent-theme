...
<?php global $ttfmake_section_data, $ttfmake_is_js_template; ?>
<?php $section_name = ttfmake_get_section_name( $ttfmake_section_data, $ttfmake_is_js_template ); ?>
...
<?php endif; ?>
	...
	<div class="wsuwp-builder-meta" style="width:100%; margin-top:10px;">
		<label for="builder_section_classes">Section Classes</label><input type="text" class="wsuwp-builder-section-classes widefat" name="builder_section_classes" value="<?php if ( isset( $ttfmake_section_data['data']['section-classes'] ) ) echo esc_attr( $ttfmake_section_data['data']['section-classes'] ); ?>" />
	</div>
