...
$sideleft_columns = spine_get_column_data( $ttfmake_section_data, 2 );
...
$section_layout = ( isset( $ttfmake_section_data['section-layout'] ) ) ? $ttfmake_section_data['section-layout'] : 'side-left';
