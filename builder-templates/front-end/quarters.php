...
$data_columns = spine_get_column_data( $ttfmake_section_data, 4 );
...
?>
	<section id="builder-section-<?php echo esc_attr( $ttfmake_section_data['id'] ); ?>" class="row quarters <?php echo esc_attr( $section_classes ); ?>">
		<?php
