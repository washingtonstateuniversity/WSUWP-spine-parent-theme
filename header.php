...
<div id="jacket" class="style-<?php echo esc_attr( spine_get_option( 'theme_style' ) ); echo $opensans_included; ?> spacing-<?php echo esc_attr( spine_get_option( 'theme_spacing' ) ); ?>">
